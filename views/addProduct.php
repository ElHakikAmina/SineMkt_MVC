...
<!--[if lte IE 9]>
        ...
        <div class="contact-form">
			...
			<form method="post" action="#" enctype="multipart/form-data">
            	<input type="text" name="name" class="contact_input_NameEmail" placeholder="Product Name ..." style="align:center;"> <br><br><br>
            	<input type="text" name="price" class="contact_input_NameEmail" placeholder="Product Price ..."><br><br><br>
				...
				<div class="hm-foot-email">
					<div class="foot-email-box">
                    	<button name="add" style="border-radius:5px; padding-top:10px; padding-bottom:10px; background-color: #e99c6b; color: white; width:200px; text-align: center;">
                        Add Product</button>
			</form>		
				</div><!--/.foot-email-box-->
