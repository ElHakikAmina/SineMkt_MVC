...
<html class="no-js" lang="en">
    ...
    <head>
		...
		<title>Home | SineMkt High Quality Furniture </title>
										...
										<div class="col-sm-5">
											<div class="single-welcome-hero">
												<div class="welcome-hero-img">
													<img src="views/assets/images/slider/slider1.png" alt="SineMkt High Quality Furniture">
												</div><!--/.welcome-hero-txt-->
											</div><!--/.single-welcome-hero-->
										</div><!--/.col-->
									</div><!--/.row-->
								...
								<div class="welcome-hero-content">
									<div class="row">
										...
										<div class="col-sm-5">
											<div class="single-welcome-hero">
												<div class="welcome-hero-img">
													<img src="views/assets/images/slider/slider2.png" alt="SineMkt High Quality Furniture">
												</div><!--/.welcome-hero-txt-->
											</div><!--/.single-welcome-hero-->
										</div><!--/.col-->
									</div><!--/.row-->
								...
								<div class="welcome-hero-content">
									<div class="row">
										...
										<div class="col-sm-5">
											<div class="single-welcome-hero">
												<div class="welcome-hero-img">
													<img src="views/assets/images/slider/slider3.png" alt="SineMkt High Quality Furniture">
												</div><!--/.welcome-hero-txt-->
											</div><!--/.single-welcome-hero-->
										</div><!--/.col-->
									</div><!--/.row-->
						...
						<div class="col-md-3">
							<div class="single-populer-products">
								<div class="single-populer-product-img mt40">
									<img src="views/assets/images/populer-products/p1.png" alt="populer-products images">
								</div>
									...
									<div class="row">
										<div class="col-md-4 col-sm-12">
											<div class="single-inner-populer-product-img">
												<img src="views/assets/images/populer-products/p2.png" alt="populer-products images">
											</div>
										</div>
							...
							<div class="single-populer-products">
								<div class="single-populer-products">
									<div class="single-populer-product-img">
										<img src="views/assets/images/populer-products/p3.png" alt="populer-products images">
									</div>
		...
		<section id="clients"  class="clients">
			<div class="container">
				<div class="owl-carousel owl-theme" id="client">
						<div class="item">
							<a href="#">
								<img src="views/assets/images/clients/c1.png" alt="SineMkt High Quality Furniture" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
