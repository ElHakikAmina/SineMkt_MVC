...
<!--[if lte IE 9]>
        ...
        <div class="contact-form">
			<h1>Contact us</h1> <br>
            <input type="text" class="contact_input_NameEmail" placeholder="Enter your name ..." style="align:center;"> <br><br><br>
            <input type="text" class="contact_input_NameEmail" placeholder="Enter your valid Email ..."><br><br><br>
			...
			<div class="hm-foot-email">
				<div class="foot-email-box">
					<textarea name="" id="" placeholder="Enter your message ..." class="form-control-contact" cols="30" rows="10"></textarea>
					<!-- <input type="text"  placeholder="Enter Email Here...."> -->
				</div><!--/.foot-email-box-->
				<div class="foot-email-subscribe-contact">
